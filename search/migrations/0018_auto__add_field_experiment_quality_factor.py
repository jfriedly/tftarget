...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.quality_factor'
        db.add_column('search_experiment', 'quality_factor',
                      self.gf('django.db.models.fields.FloatField')(default=-1.2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.quality_factor'
        db.delete_column('search_experiment', 'quality_factor')
